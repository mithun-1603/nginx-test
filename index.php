    ...
    <div class="modal fade" id="about-modal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <td><strong> Chittimalla Mithun Kumar</strong> - JBIET</td>
                    </tr>
                    ...
                    <td><strong> contact@codehubcse.live</strong></td>
                    </tr>
  ...
  <strong>Register <a href="create_account.php">here &raquo;</a></strong> &nbsp;&nbsp;&nbsp; 
    ...
    <footer class="footer">
      <div class="container">
        ...
        <font size="2" class="pull-left"><strong>Judging Management System &COPY; <?= date("Y")?> &COPY; Mithun Kumar </strong></font> <br />
